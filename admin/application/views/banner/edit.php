...
<section class="content">
    ...
    <div class="box box-primary">
     ...
     <form class=" add-ca-in" method="post" enctype="multipart/form-data" action="<?php echo base_url()?>banner/update">
    ...
    <div class="row">
       ...
       <div class="col-md-6">
        <div class="form-group">
           <a data-toggle="modal" data-target="#cropModal"><img height="100" width="100" src="<?= CUSTOM_BASE_URL . 'uploads/banner/'.$row['image']; ?>" class="img-responsive"></a>
...
<!-- /.content -->
  ...
  <?php include('assets/include/footer.php'); ?>
    <script type="text/javascript" src="<?= CUSTOM_BASE_URL .'assets/plugins/crop/home_banner.js'?>"></script>
  <script>
