         ...
         <a class="cropModal" data-toggle="modal" data-target="#cropModal">
          ...
          <div class="col-md-6">
            ...
            <select class="form-control selectpicker" name="cat_id" data-live-search="true">
              ...
              <option value="<?= $cat['cat_id'];?>" <?php if ($cat['cat_id'] == $row['cat_id']) { ?> selected="selected" <?php } ?>> <?php echo $cat['cat_name']; ?></option>
            <?php } ?>
    ...
    <div class="col-md-12">
                <div class="form-group">
                    <label>Description</label>
                     <textarea id="editor" name="description" class="form-control" rows="3"><?php echo $row['description']; ?></textarea>
