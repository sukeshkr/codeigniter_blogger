...
<section class="content">
    ...
    <div class="box box-primary">
     ...
     <form class=" add-ca-in" method="post" enctype="multipart/form-data" action="<?php echo base_url()?>banner_bottom/update">
    ...
    <div class="row">
       ...
       <div class="col-md-6">
        <div class="form-group">
           <a data-toggle="modal" data-target="#cropModal"><img height="100" width="100" src="<?= CUSTOM_BASE_URL . 'uploads/banner_bottom/'.$row['image']; ?>" class="img-responsive"></a>
...
<!-- /.content -->
  ...
  <script>
    ...
    $("#cancel").click(function () {//jquery cancel function when cancel button click
      window.location = '<?= CUSTOM_BASE_URL . "banner_bottom" ?>';
