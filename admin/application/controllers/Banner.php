...
class Banner extends MY_Auth_Controller {
    ...
    public function bannerlist() {
        ...
        foreach ($list as $banner) {
	        ...
	        $row[] = '<img src="'.CUSTOM_BASE_URL.'uploads/banner/'.$banner['image'].'" class="img-responsive" height=60 width=80 /></a>';
	          
	        //add html for action
	        $row[] = '<a href="banner/edit/'.$banner['id'].'" class="btn  btn-warning" href="#"><i class="fa fa-edit" aria-hidden="true"></i></a>
