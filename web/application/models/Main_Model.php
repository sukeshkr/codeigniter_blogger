...
class Main_Model extends MY_Model {
    ...
    public function getMainBanner() {
        ...
        $this->db->select('banner.banner_name,banner.priority,banner.image');
        $this->db->from('banner');
        $query = $this->db->get();
    ...
    public function getLongBanner() {
        ...
        $this->db->select('botbanner.image');
        $this->db->from('botbanner');
        $this->db->limit(1);
        $query = $this->db->get();
    ...
    public function getMainCategorys() {
        ...
        $this->db->select('cart_category.cat_name,cart_category.image as img_name,cart_category.cat_icon');
    ...
    public function getFlashSaleList()
    {
        ...
        $this->db->select('flash_sale.id,flash_sale.caption,cart_stock.list_price,cart_stock.stock_name,cart_product_image.image');
        $this->db->from('flash_sale');
        $this->db->join('cart_stock', 'flash_sale.stock_id = cart_stock.id');
        $this->db->join('cart_product_image', 'cart_stock.id = cart_product_image.stock_id');
        $this->db->where('flash_sale.offer_start <=', $date);
        $this->db->where('flash_sale.offer_end >=', $date);
        $this->db->order_by('flash_sale.id','DESC');
        $this->db->limit(10);
        $query = $this->db->get();
