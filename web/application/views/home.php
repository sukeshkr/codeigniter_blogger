				...
				<div class="slider">
					<ul class="slides">
						...
						<li class="slider-item">
							<img src="<?= CUSTOM_BASE_URL . 'admin/uploads/banner/'.$banner_row['image']; ?>" alt="Image">
							<div class="caption right-align">
								<a href="#" class="tag l-blue w100dt mb-30"><?= $banner_row['banner_name']; ?></a>
		...
		<section id="daily-lifestyle-section" class="daily-lifestyle-section mb-50">
			<div class="container">
				...
				<div class="owl-carousel small-carousel owl-theme">
					...
					<?php foreach ($main_category as $key => $cat_row) { ?>

					<div class="item">
						<div class="card horizontal">
							<div class="card-image">
								<img src="<?= CUSTOM_BASE_URL . 'admin/uploads/category/crop/'.$cat_row['img_name']; ?>" alt="Image">
								<span class="effect"></span>
							</div>
							<!-- /.card-image -->
							<div class="card-stacked">
								<div class="card-content">
									<a href="#" class="tag left l-blue mb-10"><?= $banner_row['cat_name']; ?></a>
									<a href="single-blog.html" class="sm-name">Trud Exercitation EllaMcop Saboris</a>
								</div>
								<!-- /.card-content -->
								<div class="card-action">
									<p class="hero left">
										BY - <a href="#" class="l-blue">Abid Koodathai</a>
									</p>
				...
				<div class="row">
					...
					<div class="col s12 m8 l8">
						...
						<div class="blogs mb-30">
							<div class="card">
								<div class="card-image">
									<img src="<?php echo base_url();?>assets/img/selfie.jpg" alt="Image">
						...
						<div class="blogs mb-30">
							<div class="card">
								<div class="card-image">
									<img src="<?php echo base_url();?>assets/img/blog4.jpg" alt="Image">
									<a class="btn-floating center-align cmn-bgcolor halfway-fab waves-effect waves-light">
										<i class="icofont icofont-camera-alt"></i>
									</a>
								</div>
						...
						<div class="blogs mb-30">
							<div class="card">
								<div class="card-image">
									<img src="<?php echo base_url();?>assets/img/travel2.jpg" alt="Image">
									<a class="btn-floating center-align cmn-bgcolor halfway-fab waves-effect waves-light">
										<i class="icofont icofont-camera-alt"></i>
									</a>
								</div>
						...
						<div class="blogs mb-30">
							<div class="card">
								<div class="card-image">
									<img src="<?php echo base_url();?>assets/img/fashion2.jpg" alt="Image">
									<a class="btn-floating center-align cmn-bgcolor halfway-fab waves-effect waves-light">
										<i class="icofont icofont-camera-alt"></i>
									</a>
								</div>
							...
							<div class="sidebar-posts">
								<div class="card">
									<div class="card-image mb-10">
										<img src="<?php echo base_url();?>assets/img/blog3.jpg" alt="Image">
										<span class="effect"></span>
									</div>
									<!-- /.card-image -->
									<div class="card-content w100dt">
								...
								<div class="card">
									<div class="card-image mb-10">
										<img src="<?php echo base_url();?>assets/img/blog1.jpg" alt="Image">
										<span class="effect"></span>
									</div>
									<!-- /.card-image -->
									<div class="card-content w100dt">
								...
								<div class="card">
									<div class="card-image mb-10">
										<img src="<?php echo base_url();?>assets/img/blog2.jpg" alt="Image">
										<span class="effect"></span>
									</div>
									<!-- /.card-image -->
									<div class="card-content w100dt">
						...
						<div class="top-post w100dt mb-30">
							...
							<div id="test-swipe-1" class="tab-contant most-view">
								...
								<div class="sidebar-posts">
									<div class="card">
										<div class="card-image mb-10">
											<img src="<?php echo base_url();?>assets/img/fashion.jpg" alt="Image">
											<span class="effect"></span>
										</div>
										<!-- /.card-image -->
										<div class="card-content w100dt">
									...
									<div class="hot-post w100dt mb-10">
										<div class="hot-post-image">
											<img src="<?php echo base_url();?>assets/img/img3.jpg" alt="Image">
											<span class="effect"></span>
										</div>
										<!-- /.hot-post-image -->
									...
									<div class="hot-post w100dt mb-10">
										<div class="hot-post-image">
											<img src="<?php echo base_url();?>assets/img/img2.jpg" alt="Image">
											<span class="effect"></span>
										</div>
										<!-- /.hot-post-image -->
										<div class="hot-post-stacked">
									...
									<div class="hot-post w100dt mb-10">
										<div class="hot-post-image">
											<img src="<?php echo base_url();?>assets/img/img1.jpg" alt="Image">
											<span class="effect"></span>
										</div>
										<!-- /.hot-post-image -->
										<div class="hot-post-stacked">
							...
							<div id="test-swipe-3" class="tab-contant Comments-post">
								...
								<div class="card-panel grey lighten-5 z-depth-1">
									<div class="row valign-wrapper">
										<div class="col s3">
											<img src="<?php echo base_url();?>assets/img/img1.png" alt="Image" class="circle responsive-img"> <!-- notice the "circle" class -->
										</div>
										<div class="col s9">
								...
								<div class="card-panel grey lighten-5 z-depth-1">
									<div class="row valign-wrapper">
										<div class="col s3">
											<img src="<?php echo base_url();?>assets/img/img2.png" alt="Image" class="circle responsive-img"> <!-- notice the "circle" class -->
										</div>
										<div class="col s9">
											<span class="black-text">
												Lorem ipsum dolor sit amet, consectetur adipisicing elit.
								...
								<div class="card-panel grey lighten-5 z-depth-1">
									<div class="row valign-wrapper">
										<div class="col s3">
											<img src="<?php echo base_url();?>assets/img/img3.png" alt="Image" class="circle responsive-img"> <!-- notice the "circle" class -->
										</div>
										<div class="col s9">
											<span class="black-text">
												Lorem ipsum dolor sit amet, consectetur adipisicing elit.
